...
public interface IAdministratorDataAccess {
    ...
    /**
     * Saves the administrators changes. When the save is performed locally, the administrator
     * is either added or updated in the local database set.
     * @param administrators The administrator to save
     */
