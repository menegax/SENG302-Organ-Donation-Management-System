...
public class GlobalEnums {
	...
	public enum UIRegex {
        ...
        DONATINGLIST("^[a-zA-Z\\s]+\\s\\|\\s(\\w{3}\\d{4})$"), RECEIVINGLIST("^[a-zA-Z\\s]+\\s\\|\\s.{10}\\s\\|\\s(\\w{3}\\d{4})$");
    ...
    public enum UndoableScreen {
        ...
        CLINICIANPROFILE("clinicianProfile"), ADMINISTRATORPROFILE("administratorProfile");
