...
//        middle.add("James");
//        Database.addPatient(new Patient("TFX1121", "NBA", middle, "Reddit",
//                LocalDate.of(2008, 2, 9)));
//        Database.getPatientByNhi("TFX1121").addDonation(GlobalEnums.Organ.LIVER);
//        patient = Database.getPatientByNhi("TFX1121");
//    }
//
//    /**
...
//        System.out.println("*****************");
//        TableView test = lookup("#patientDataTable").queryAs(TableView.class);
//        for (Object obj : test.getItems()) {
//            if (obj instanceof Patient) {
//                System.out.println(((Patient) obj).getFirstName());
//            }
//        }
//        System.out.println("*****************");
//        verifyThat("#patientDataTable", TableViewMatchers.hasTableCell("NBA James Reddit"));
//        interact(() -> {
//            doubleClickOn("NBA James Reddit");
//        });
